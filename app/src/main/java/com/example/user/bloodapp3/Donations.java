...
public class Donations extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog1,Requests.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog1, Requests.BlogViewHolder>(
                Blog1.class,
                R.layout.blog_row1,
                Requests.BlogViewHolder.class,
                mDatabase

        ) {
            @Override
            protected void populateViewHolder(Requests.BlogViewHolder viewHolder, Blog1 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Donations.this,Detail1.class);
