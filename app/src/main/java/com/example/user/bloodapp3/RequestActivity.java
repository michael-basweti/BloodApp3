...
public class RequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSMS=(Button)findViewById(R.id.button7);
    ...
    private void post() {
        ...
        if (!TextUtils.isEmpty(relationship)) {
                    ...
                    newPost.child("Name").setValue("Username:" + dataSnapshot.child("Name").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(RequestActivity.this, "Please fill all the spaces or check your internet connection...", Toast.LENGTH_LONG).show();
            ...
            mProgress.dismiss();
            Toast.makeText(RequestActivity.this, "Your Data Has been sent", Toast.LENGTH_LONG).show();
